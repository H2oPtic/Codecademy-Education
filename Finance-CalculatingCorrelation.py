...
print('The correlation coefficient between General Motors and ExxonMobil is ',  corr_gm_exxon)

corr_gm_appl = calculate_correlation(returns_general_motors, returns_apple)
print('The correlation coefficient between General Motors and Apple is ', corr_gm_appl)
